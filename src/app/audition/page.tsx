        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          >
            ...
            <p className="text-sm leading-relaxed font-light" style={{ color: "var(--text-secondary)" }}>
              ...
              {locale === "ja" && "国籍、性別、年齢制限なし。夢と情熱のある方ならどなたでも応募可能です。"}
            </p>
          </div>
        </div>
        ...
        >
          ...
          {submitted ? (
            <div className="text-center py-16 animate-fadeInUp">
              <span className="text-brand-pink text-5xl">✓</span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <select required style={inputStyle}>
                    {infoFields.genderOptions.map((opt, idx) => (
                      <option key={idx} value={opt} style={{ backgroundColor: "var(--bg-card)", color: "var(--text-primary)" }}>
                        {opt}
                      </option>
                    ))}
                  </select>
