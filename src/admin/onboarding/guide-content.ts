...
export const GUIDE_STEPS: GuideStep[] = [
  ...
  { id: "2-album-delete", chapterId: "2", title: "앨범 삭제", controlLabel: "삭제", purpose: "현재 앨범을 삭제 대상으로 표시합니다.", outcome: "상단 저장 후 앨범과 연결 데이터가 삭제됩니다.", caution: "수록곡과 미디어 연결도 함께 영향을 받습니다.", href: "/admin/artists/:artistId/discography", target: "entity-delete", interaction: { target: "entity-list-item", instruction: "먼저 왼쪽 앨범 목록에서 기존 앨범을 선택해 주세요." }, requires: "artist", ...fallback },
  ...
  { id: "5-memo", chapterId: "5", title: "문의 메모 저장", controlLabel: "메모 저장", purpose: "담당자 확인 내용과 후속 조치를 관리자 전용 메모로 남깁니다.", outcome: "공개되지 않는 내부 기록으로 즉시 저장됩니다.", href: "/admin/contact", target: "contact-workspace", interaction: { target: "contact-open", instruction: "먼저 문의 목록에서 ‘열기’를 클릭해 상세 화면을 열어주세요." }, ...fallback },
  { id: "5-status", chapterId: "5", title: "문의 처리 상태", controlLabel: "접수 · 검토 중 · 답변 완료 · 종결", purpose: "문의 처리 흐름에 맞춰 현재 상태를 기록합니다.", outcome: "선택 상태가 즉시 저장되고 사이드바 미확인 수가 갱신됩니다.", href: "/admin/contact", target: "contact-workspace", interaction: { target: "contact-open", instruction: "먼저 문의 목록에서 ‘열기’를 클릭해 상세 화면을 열어주세요." }, ...fallback },
  ...
  { id: "6-source", chapterId: "6", title: "원문 게시물 확인", controlLabel: "원문 게시물 열기", purpose: "신고 근거가 되는 외부 게시물을 확인합니다.", outcome: "원문 주소가 새 창에서 열립니다.", caution: "외부 사이트를 열기 전에 주소를 확인하세요.", href: "/admin/protect", target: "protect-workspace", interaction: { target: "protect-open", instruction: "먼저 신고 목록에서 ‘열기’를 클릭해 상세 화면을 열어주세요." }, ...fallback },
  { id: "6-evidence", chapterId: "6", title: "첨부 증거 확인", controlLabel: "첨부 자료", purpose: "신고자가 제출한 비공개 증거 파일을 확인합니다.", outcome: "짧게 유효한 보안 링크로 원본 자료가 열립니다.", caution: "민감한 증거 자료를 외부에 공유하지 마세요.", href: "/admin/protect", target: "protect-workspace", interaction: { target: "protect-open", instruction: "먼저 신고 목록에서 ‘열기’를 클릭해 상세 화면을 열어주세요." }, ...fallback },
  { id: "6-memo", chapterId: "6", title: "권익 보호 메모", controlLabel: "메모 저장", purpose: "검토 내용과 후속 조치를 관리자 전용 기록으로 남깁니다.", outcome: "공개되지 않는 내부 메모로 즉시 저장됩니다.", href: "/admin/protect", target: "protect-workspace", interaction: { target: "protect-open", instruction: "먼저 신고 목록에서 ‘열기’를 클릭해 상세 화면을 열어주세요." }, ...fallback },
  { id: "6-status", chapterId: "6", title: "신고 처리 상태", controlLabel: "접수 · 검토 중 · 처리 완료 · 종결", purpose: "신고 처리 단계에 맞춰 상태를 기록합니다.", outcome: "선택 상태가 즉시 저장되고 미확인 수가 갱신됩니다.", href: "/admin/protect", target: "protect-workspace", interaction: { target: "protect-open", instruction: "먼저 신고 목록에서 ‘열기’를 클릭해 상세 화면을 열어주세요." }, ...fallback },
  ...
  { id: "7-detail", chapterId: "7", title: "변경 상세 비교", controlLabel: "상세 보기", purpose: "선택 기록의 변경 전후 값을 필드 단위로 비교합니다.", outcome: "오른쪽 패널에 작업자, 시각, 이전 값과 이후 값이 표시됩니다.", href: "/admin/audit-logs", target: "audit-open", actionHint: "강조된 화살표를 직접 클릭해 변경 상세를 열어보세요.", ...fallback },
