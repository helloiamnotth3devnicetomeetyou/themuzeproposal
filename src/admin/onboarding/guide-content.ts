...
const GUIDE_STEP_INPUTS: GuideStepInput[] = [
  ...
  { id: "2-language-tabs", chapterId: "2", title: "작성 언어 전환", controlLabel: "KR · EN · JP", purpose: "화면 상단 언어 탭 하나로 이 화면의 모든 다국어 입력을 함께 전환합니다.", outcome: "선택한 언어로 제목, 소개와 세부 입력을 이어서 편집할 수 있습니다.", href: "/admin/artists/:artistId/profile?tab=content", target: "editor-language-tabs", tabEvent: { name: "admin-profile-tab-change", detail: "content" }, requires: "artist", ...fallback },
  ...
  { id: "2-profile-preview", chapterId: "2", title: "프로필 미리보기", controlLabel: "미리보기", purpose: "저장 전 현재 입력값이 공개 프로필에서 어떻게 보이는지 확인합니다.", outcome: "분홍 외곽선과 변경 대상 배너가 표시되며, 미리보기 범위를 벗어날 때 확인 안내가 뜹니다.", href: "/admin/artists/:artistId/profile?tab=publish", target: "preview", tabEvent: { name: "admin-profile-tab-change", detail: "publish" }, requires: "artist", ...fallback },
  ...
  { id: "2-profile-delete", chapterId: "2", title: "아티스트 삭제", controlLabel: "더보기 · 삭제", purpose: "더보기 메뉴에서 아티스트와 연결된 콘텐츠의 삭제를 준비합니다.", outcome: "연습 모드에서는 실제 데이터가 삭제되지 않습니다.", caution: "실제 업무에서는 연결된 멤버·앨범·일정에 영향을 주므로 최종 확인이 필요합니다.", href: "/admin/artists/:artistId/profile?tab=publish", target: "editor-more-actions", tabEvent: { name: "admin-profile-tab-change", detail: "publish" }, requires: "artist", ...fallback },
  ...
  { id: "2-member-preview", chapterId: "2", title: "멤버 미리보기", controlLabel: "미리보기", purpose: "저장 전 멤버 공개 화면을 확인합니다.", outcome: "외곽선과 변경 대상 배너가 표시된 별도 미리보기 화면이 열립니다.", href: "/admin/artists/:artistId/members", target: "preview", requires: "artist", ...fallback },
  ...
  { id: "2-member-delete", chapterId: "2", title: "멤버 삭제", controlLabel: "더보기 · 삭제", purpose: "더보기 메뉴에서 현재 멤버를 삭제 대상으로 표시합니다.", outcome: "상단 저장 후 멤버가 삭제됩니다.", caution: "멤버가 연결된 장면 영역과 콘텐츠를 먼저 확인하세요.", href: "/admin/artists/:artistId/members", target: "editor-more-actions", interaction: { target: "entity-list-item", instruction: "먼저 왼쪽 목록에서 기존 멤버를 선택해 주세요." }, requires: "artist", ...fallback },
  ...
  { id: "2-album-preview", chapterId: "2", title: "앨범 미리보기", controlLabel: "미리보기", purpose: "저장 전 앨범 공개 화면을 확인합니다.", outcome: "외곽선과 변경 대상 배너가 표시된 별도 미리보기 화면이 열립니다.", href: "/admin/artists/:artistId/discography?tab=tracks", target: "preview", requires: "artist", ...fallback },
  ...
  { id: "2-album-delete", chapterId: "2", title: "앨범 삭제", controlLabel: "더보기 · 삭제", purpose: "더보기 메뉴에서 현재 앨범을 삭제 대상으로 표시합니다.", outcome: "연습 모드에서는 실제 앨범과 연결 데이터가 삭제되지 않습니다.", caution: "실제 업무에서는 수록곡과 미디어 연결도 함께 영향을 받습니다.", href: "/admin/artists/:artistId/discography?tab=tracks", target: "editor-more-actions", interaction: { target: "entity-list-item", instruction: "먼저 왼쪽 앨범 목록에서 기존 앨범을 선택해 주세요." }, requires: "artist", ...fallback },
  ...
  { id: "2-schedule-preview", chapterId: "2", title: "일정 미리보기", controlLabel: "미리보기", purpose: "저장 전 공개 일정 화면을 확인합니다.", outcome: "외곽선과 변경 대상 배너가 표시된 별도 미리보기 화면이 열립니다.", href: "/admin/artists/:artistId/schedule", target: "preview", requires: "artist", ...fallback },
  { id: "2-schedule-duplicate", chapterId: "2", title: "일정 복제", controlLabel: "복제", purpose: "저장된 일정의 내용과 링크를 새 비공개 초안으로 복사합니다.", outcome: "새 ID는 저장할 때만 만들어지고, 공개 상태는 해제됩니다.", href: "/admin/artists/:artistId/schedule", target: "entity-duplicate", interaction: { target: "entity-list-item", instruction: "먼저 왼쪽 목록에서 기존 일정을 선택해 주세요." }, requires: "artist", ...fallback },
  ...
  { id: "2-schedule-delete", chapterId: "2", title: "일정 삭제", controlLabel: "더보기 · 삭제", purpose: "더보기 메뉴에서 현재 일정을 삭제 대상으로 표시합니다.", outcome: "상단 저장 후 일정이 삭제됩니다.", href: "/admin/artists/:artistId/schedule", target: "editor-more-actions", interaction: { target: "entity-list-item", instruction: "먼저 왼쪽 일정 목록에서 기존 일정을 선택해 주세요." }, requires: "artist", ...fallback },
  ...
  { id: "2-notice-preview", chapterId: "2", title: "아티스트 공지 미리보기", controlLabel: "미리보기", purpose: "저장 전 공개 공지 화면을 확인합니다.", outcome: "외곽선과 변경 대상 배너가 표시된 별도 미리보기 화면이 열립니다.", href: "/admin/artists/:artistId/notices", target: "preview", requires: "artist", ...fallback },
  { id: "2-notice-duplicate", chapterId: "2", title: "아티스트 공지 복제", controlLabel: "복제", purpose: "저장된 공지의 내용을 새 비공개 초안으로 복사합니다.", outcome: "새 ID는 저장할 때만 만들어지고, 공개 상태는 해제됩니다.", href: "/admin/artists/:artistId/notices", target: "entity-duplicate", interaction: { target: "entity-list-item", instruction: "먼저 왼쪽 목록에서 기존 공지를 선택해 주세요." }, requires: "artist", ...fallback },
  ...
  { id: "2-notice-delete", chapterId: "2", title: "아티스트 공지 삭제", controlLabel: "더보기 · 삭제", purpose: "더보기 메뉴에서 현재 공지를 삭제 대상으로 표시합니다.", outcome: "상단 저장 후 공지가 삭제됩니다.", href: "/admin/artists/:artistId/notices", target: "editor-more-actions", interaction: { target: "entity-list-item", instruction: "먼저 왼쪽 공지 목록에서 기존 공지를 선택해 주세요." }, requires: "artist", ...fallback },
  ...
  { id: "3-preview", chapterId: "3", title: "공지 미리보기", controlLabel: "미리보기", purpose: "저장 전에 공개 공지 화면을 확인합니다.", outcome: "외곽선과 변경 대상 배너가 표시된 별도 미리보기 화면이 열립니다.", href: "/admin/notices", target: "preview", ...fallback },
  { id: "3-duplicate", chapterId: "3", title: "공지 복제", controlLabel: "복제", purpose: "저장된 공지의 내용을 새 비공개 초안으로 복사합니다.", outcome: "새 ID는 저장할 때만 만들어지고, 공개 상태는 해제됩니다.", href: "/admin/notices", target: "entity-duplicate", interaction: { target: "entity-list-item", instruction: "먼저 왼쪽 목록에서 기존 공지를 선택해 주세요." }, ...fallback },
  ...
  { id: "3-delete", chapterId: "3", title: "공지 삭제", controlLabel: "더보기 · 삭제", purpose: "더보기 메뉴에서 현재 공지를 삭제 대상으로 표시합니다.", outcome: "상단 저장을 눌러야 서버에서 실제 삭제됩니다.", href: "/admin/notices", target: "editor-more-actions", interaction: { target: "entity-list-item", instruction: "먼저 왼쪽 공지 목록에서 기존 공지를 선택해 주세요." }, ...fallback },
  ...
  { id: "8-preview", chapterId: "8", title: "설정 미리보기", controlLabel: "미리보기", purpose: "현재 설정 초안이 공개 페이지에서 보이는 결과를 확인합니다.", outcome: "외곽선과 변경 대상 배너가 표시된 관련 공개 화면이 열립니다.", href: "/admin/settings?tab=business", target: "preview", tabEvent: { name: "admin-settings-tab-change", detail: "business" }, ...fallback },
