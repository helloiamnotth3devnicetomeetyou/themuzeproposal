...
export const GUIDE_STEPS: GuideStep[] = [
  ...
  { id: "2-create-next", chapterId: "2", title: "2-1. 다음 입력 단계", controlLabel: "다음", purpose: "현재 단계의 필수 입력을 확인하고 다음 프로필 입력 단계로 이동합니다.", outcome: "서버 저장 없이 다음 입력 단계가 열립니다.", href: "/admin/artists/new/profile", target: "profile-wizard-navigation", ...fallback },
  { id: "2-create-back", chapterId: "2", title: "2-1. 이전 입력 단계", controlLabel: "이전", purpose: "앞에서 입력한 아티스트 정보를 다시 확인합니다.", outcome: "입력값을 유지한 채 이전 단계가 열립니다.", href: "/admin/artists/new/profile", target: "profile-wizard-navigation", ...fallback },
  ...
  { id: "2-profile-basic", chapterId: "2", title: "프로필 기본 정보", controlLabel: "기본 정보", purpose: "아티스트명과 식별 정보를 편집하는 탭을 엽니다.", outcome: "기본 정보 입력 영역이 표시됩니다.", href: "/admin/artists/:artistId/profile", target: "workbench-tab-basic", requires: "artist", ...fallback },
  { id: "2-profile-visual", chapterId: "2", title: "프로필 비주얼", controlLabel: "비주얼", purpose: "대표 이미지와 브랜드 색상을 편집하는 탭을 엽니다.", outcome: "비주얼 입력 영역이 표시됩니다.", href: "/admin/artists/:artistId/profile", target: "workbench-tab-visual", requires: "artist", ...fallback },
  { id: "2-profile-content", chapterId: "2", title: "프로필 소개", controlLabel: "소개", purpose: "다국어 아티스트 소개를 편집하는 탭을 엽니다.", outcome: "소개 입력 영역이 표시됩니다.", href: "/admin/artists/:artistId/profile", target: "workbench-tab-content", requires: "artist", ...fallback },
  { id: "2-profile-social", chapterId: "2", title: "프로필 공식 계정", controlLabel: "공식 계정", purpose: "공식 SNS 링크를 편집하는 탭을 엽니다.", outcome: "공식 계정 입력 영역이 표시됩니다.", href: "/admin/artists/:artistId/profile", target: "workbench-tab-social", requires: "artist", ...fallback },
  { id: "2-profile-publish", chapterId: "2", title: "프로필 공개 설정", controlLabel: "공개 설정", purpose: "프로필의 공개 여부를 관리하는 탭을 엽니다.", outcome: "공개 상태 입력 영역이 표시됩니다.", href: "/admin/artists/:artistId/profile", target: "workbench-tab-publish", requires: "artist", ...fallback },
  { id: "2-profile-preview", chapterId: "2", title: "프로필 미리보기", controlLabel: "미리보기", purpose: "저장 전 현재 입력값이 공개 프로필에서 어떻게 보이는지 확인합니다.", outcome: "별도 미리보기 화면이 열리며 공개 데이터는 바뀌지 않습니다.", href: "/admin/artists/:artistId/profile", target: "preview", requires: "artist", ...fallback },
  { id: "2-profile-save", chapterId: "2", title: "프로필 저장", controlLabel: "변경사항 저장", purpose: "프로필과 하위 갤러리·장면 임시 작업을 함께 저장합니다.", outcome: "검증을 통과한 정보가 서버와 공개 화면에 반영됩니다.", href: "/admin/artists/:artistId/profile", target: "draft-save", requires: "artist", ...fallback },
  { id: "2-profile-delete", chapterId: "2", title: "아티스트 삭제", controlLabel: "삭제", purpose: "아티스트와 연결된 콘텐츠의 삭제를 준비합니다.", outcome: "이름 확인 후 상단 저장을 눌러야 실제 삭제됩니다.", caution: "연결된 멤버·앨범·일정에 영향을 주므로 최종 확인이 필요합니다.", href: "/admin/artists/:artistId/profile", target: "entity-delete", requires: "artist", ...fallback },
  ...
  { id: "2-member-delete", chapterId: "2", title: "멤버 삭제", controlLabel: "삭제", purpose: "현재 멤버를 삭제 대상으로 표시합니다.", outcome: "상단 저장 후 멤버가 삭제됩니다.", caution: "멤버가 연결된 장면 영역과 콘텐츠를 먼저 확인하세요.", href: "/admin/artists/:artistId/members", target: "workbench-actions", requires: "artist", ...fallback },
  ...
  { id: "2-track-media", chapterId: "2", title: "트랙 미디어 열기", controlLabel: "미디어", purpose: "트랙별 음원·영상 입력 영역을 펼칩니다.", outcome: "MP3, Spotify와 YouTube 정보를 편집할 수 있습니다.", href: "/admin/artists/:artistId/discography?tab=tracks", target: "track-actions", requires: "artist", ...fallback },
  { id: "2-track-delete", chapterId: "2", title: "트랙 삭제", controlLabel: "삭제", purpose: "해당 트랙을 앨범 초안에서 제거합니다.", outcome: "앨범 저장 후 트랙이 실제로 삭제됩니다.", href: "/admin/artists/:artistId/discography?tab=tracks", target: "track-actions", requires: "artist", ...fallback },
  { id: "2-album-preview", chapterId: "2", title: "앨범 미리보기", controlLabel: "미리보기", purpose: "저장 전 앨범 공개 화면을 확인합니다.", outcome: "공개 데이터 변경 없이 미리보기 화면이 열립니다.", href: "/admin/artists/:artistId/discography", target: "preview", requires: "artist", ...fallback },
  { id: "2-album-save", chapterId: "2", title: "앨범 저장", controlLabel: "변경사항 저장", purpose: "앨범·트랙·순서 변경을 서버에 반영합니다.", outcome: "확인창 승인 후 공개 앨범 정보가 갱신됩니다.", href: "/admin/artists/:artistId/discography", target: "draft-save", requires: "artist", ...fallback },
  { id: "2-album-delete", chapterId: "2", title: "앨범 삭제", controlLabel: "삭제", purpose: "현재 앨범을 삭제 대상으로 표시합니다.", outcome: "상단 저장 후 앨범과 연결 데이터가 삭제됩니다.", caution: "수록곡과 미디어 연결도 함께 영향을 받습니다.", href: "/admin/artists/:artistId/discography", target: "workbench-actions", requires: "artist", ...fallback },
  ...
  { id: "2-schedule-delete", chapterId: "2", title: "일정 삭제", controlLabel: "삭제", purpose: "현재 일정을 삭제 대상으로 표시합니다.", outcome: "상단 저장 후 일정이 삭제됩니다.", href: "/admin/artists/:artistId/schedule", target: "workbench-actions", requires: "artist", ...fallback },
  ...
  { id: "2-notice-delete", chapterId: "2", title: "아티스트 공지 삭제", controlLabel: "삭제", purpose: "현재 공지를 삭제 대상으로 표시합니다.", outcome: "상단 저장 후 공지가 삭제됩니다.", href: "/admin/artists/:artistId/notices", target: "workbench-actions", requires: "artist", ...fallback },
  ...
  { id: "3-search", chapterId: "3", title: "전체 공지 검색", controlLabel: "공지 검색", purpose: "제목으로 전체 공지를 찾습니다.", outcome: "검색어가 포함된 공지만 표시됩니다.", href: "/admin/notices", target: "notice-filters", ...fallback },
  { id: "3-filter", chapterId: "3", title: "전체 공지 공개 필터", controlLabel: "전체 · 공개 · 비공개", purpose: "공개 상태로 전체 공지 목록을 좁힙니다.", outcome: "선택한 상태의 공지만 표시됩니다.", href: "/admin/notices", target: "notice-filters", ...fallback },
  ...
  { id: "3-delete", chapterId: "3", title: "공지 삭제", controlLabel: "삭제", purpose: "현재 공지를 삭제 대상으로 표시합니다.", outcome: "상단 저장을 눌러야 서버에서 실제 삭제됩니다.", href: "/admin/notices", target: "entity-delete", ...fallback },
  ...
  { id: "4-question-add", chapterId: "4", title: "지원 질문 추가", controlLabel: "질문 추가", purpose: "지원 폼에 새 질문을 만듭니다.", outcome: "빈 질문이 질문 목록과 미리보기에 추가됩니다.", href: "/admin/auditions/campaigns", target: "audition-campaign-list", ...fallback },
  { id: "4-question-type", chapterId: "4", title: "지원 질문 유형", controlLabel: "질문 유형", purpose: "단답, 장문, 선택, 파일 등 답변 방식을 정합니다.", outcome: "질문에 맞는 입력 방식과 검증 항목이 적용됩니다.", href: "/admin/auditions/campaigns", target: "audition-campaign-list", ...fallback },
  { id: "4-question-sort", chapterId: "4", title: "지원 질문 순서", controlLabel: "드래그 정렬", purpose: "질문을 끌어 지원자가 보는 순서를 바꿉니다.", outcome: "저장할 질문 순서가 즉시 미리보기에 반영됩니다.", href: "/admin/auditions/campaigns", target: "audition-campaign-list", ...fallback },
  { id: "4-question-delete", chapterId: "4", title: "지원 질문 삭제", controlLabel: "질문 삭제", purpose: "선택 질문을 폼 초안에서 제거합니다.", outcome: "저장 후 해당 질문은 새 지원서에서 사라집니다.", caution: "기존 지원서의 제출 당시 답변 스냅샷은 유지됩니다.", href: "/admin/auditions/campaigns", target: "audition-campaign-list", ...fallback },
  { id: "4-save", chapterId: "4", title: "지원 폼 저장", controlLabel: "저장", purpose: "질문과 캠페인 설명 변경을 서버에 반영합니다.", outcome: "이후 접수되는 지원서에 새 폼 구성이 사용됩니다.", href: "/admin/auditions/campaigns", target: "audition-campaign-list", ...fallback },
  { id: "4-status", chapterId: "4", title: "지원서 심사 상태", controlLabel: "접수 · 검토 · 합격 · 불합격", purpose: "지원서별 심사 단계 버튼 중 하나를 선택합니다.", outcome: "선택한 상태와 내부 메모가 해당 지원서에 즉시 저장됩니다.", href: "/admin/auditions/campaigns", target: "audition-campaign-list", ...fallback },

  { id: "5-general", chapterId: "5", title: "일반 문의함", controlLabel: "일반 문의", purpose: "팬과 고객이 접수한 일반 문의 목록으로 전환합니다.", outcome: "일반 문의 건수와 목록이 표시됩니다.", href: "/admin/contact", target: "contact-category", ...fallback },
  { id: "5-business", chapterId: "5", title: "비즈니스 문의함", controlLabel: "Business", purpose: "협업·광고·제휴 제안 목록으로 전환합니다.", outcome: "비즈니스 제안 건수와 목록이 표시됩니다.", href: "/admin/contact", target: "contact-category", ...fallback },
  { id: "5-search", chapterId: "5", title: "문의 검색", controlLabel: "문의 검색", purpose: "이름, 연락처, 회사와 내용으로 문의를 찾습니다.", outcome: "검색어와 일치하는 문의만 표시됩니다.", href: "/admin/contact", target: "contact-filters", ...fallback },
  { id: "5-filter", chapterId: "5", title: "문의 상태 필터", controlLabel: "처리 상태", purpose: "처리 단계로 문의 목록을 좁힙니다.", outcome: "선택 상태의 문의만 표시됩니다.", href: "/admin/contact", target: "contact-filters", ...fallback },
  { id: "5-open", chapterId: "5", title: "문의 열기", controlLabel: "열기", purpose: "선택 문의의 본문, 연락처와 첨부 자료를 엽니다.", outcome: "상세 화면에서 내부 메모와 처리 상태를 관리할 수 있습니다.", href: "/admin/contact", target: "contact-open", ...fallback },
  { id: "5-memo", chapterId: "5", title: "문의 메모 저장", controlLabel: "메모 저장", purpose: "담당자 확인 내용과 후속 조치를 관리자 전용 메모로 남깁니다.", outcome: "공개되지 않는 내부 기록으로 즉시 저장됩니다.", href: "/admin/contact", target: "contact-workspace", ...fallback },
  { id: "5-status", chapterId: "5", title: "문의 처리 상태", controlLabel: "접수 · 검토 중 · 답변 완료 · 종결", purpose: "문의 처리 흐름에 맞춰 현재 상태를 기록합니다.", outcome: "선택 상태가 즉시 저장되고 사이드바 미확인 수가 갱신됩니다.", href: "/admin/contact", target: "contact-workspace", ...fallback },

  { id: "6-search", chapterId: "6", title: "권익 신고 검색", controlLabel: "신고 검색", purpose: "제목, 아티스트와 작성자로 신고를 찾습니다.", outcome: "검색어와 일치하는 신고만 표시됩니다.", href: "/admin/protect", target: "protect-filters", ...fallback },
  { id: "6-filter", chapterId: "6", title: "권익 신고 상태 필터", controlLabel: "처리 상태", purpose: "처리 단계로 신고 목록을 좁힙니다.", outcome: "선택 상태의 신고만 표시됩니다.", href: "/admin/protect", target: "protect-filters", ...fallback },
  { id: "6-open", chapterId: "6", title: "신고 열기", controlLabel: "열기", purpose: "권익 침해 내용과 신고자 자료를 상세 화면에서 확인합니다.", outcome: "원문, 증거 자료, 메모와 처리 상태를 볼 수 있습니다.", href: "/admin/protect", target: "protect-open", ...fallback },
  { id: "6-source", chapterId: "6", title: "원문 게시물 확인", controlLabel: "원문 게시물 열기", purpose: "신고 근거가 되는 외부 게시물을 확인합니다.", outcome: "원문 주소가 새 창에서 열립니다.", caution: "외부 사이트를 열기 전에 주소를 확인하세요.", href: "/admin/protect", target: "protect-workspace", ...fallback },
  { id: "6-evidence", chapterId: "6", title: "첨부 증거 확인", controlLabel: "첨부 자료", purpose: "신고자가 제출한 비공개 증거 파일을 확인합니다.", outcome: "짧게 유효한 보안 링크로 원본 자료가 열립니다.", caution: "민감한 증거 자료를 외부에 공유하지 마세요.", href: "/admin/protect", target: "protect-workspace", ...fallback },
  { id: "6-memo", chapterId: "6", title: "권익 보호 메모", controlLabel: "메모 저장", purpose: "검토 내용과 후속 조치를 관리자 전용 기록으로 남깁니다.", outcome: "공개되지 않는 내부 메모로 즉시 저장됩니다.", href: "/admin/protect", target: "protect-workspace", ...fallback },
  { id: "6-status", chapterId: "6", title: "신고 처리 상태", controlLabel: "접수 · 검토 중 · 처리 완료 · 종결", purpose: "신고 처리 단계에 맞춰 상태를 기록합니다.", outcome: "선택 상태가 즉시 저장되고 미확인 수가 갱신됩니다.", href: "/admin/protect", target: "protect-workspace", ...fallback },

  { id: "7-filter", chapterId: "7", title: "변경 이력 조회 조건", controlLabel: "조회 조건", purpose: "기간, 관리자, 대상 종류, 작업과 ID를 입력합니다.", outcome: "조회할 감사 기록의 조건이 준비됩니다.", href: "/admin/audit-logs", target: "audit-filters", ...fallback },
  { id: "7-reset", chapterId: "7", title: "변경 이력 조건 초기화", controlLabel: "초기화", purpose: "입력한 감사 기록 조회 조건을 모두 지웁니다.", outcome: "기본 조건으로 되돌아갑니다.", href: "/admin/audit-logs", target: "audit-filters", ...fallback },
  { id: "7-search", chapterId: "7", title: "변경 이력 조회", controlLabel: "이력 조회", purpose: "입력한 조건으로 감사 기록을 검색합니다.", outcome: "조건에 맞는 변경 기록이 시간순으로 표시됩니다.", href: "/admin/audit-logs", target: "audit-filters", ...fallback },
  { id: "7-detail", chapterId: "7", title: "변경 상세 비교", controlLabel: "상세 보기", purpose: "선택 기록의 변경 전후 값을 필드 단위로 비교합니다.", outcome: "오른쪽 패널에 작업자, 시각, 이전 값과 이후 값이 표시됩니다.", href: "/admin/audit-logs", target: "audit-detail", ...fallback },
  ...
  { id: "8-history-add", chapterId: "8", title: "연혁 추가", controlLabel: "연혁 추가", purpose: "새 회사 연혁 항목을 임시 목록에 추가합니다.", outcome: "날짜와 다국어 내용을 입력할 행이 생깁니다.", href: "/admin/settings?tab=history", target: "settings-history-actions", tabEvent: { name: "admin-settings-tab-change", detail: "history" }, ...fallback },
  { id: "8-history-delete", chapterId: "8", title: "연혁 삭제", controlLabel: "삭제", purpose: "선택 연혁 항목을 임시 목록에서 제거합니다.", outcome: "상단 저장 후 공개 연혁에서 사라집니다.", href: "/admin/settings?tab=history", target: "settings-history-actions", tabEvent: { name: "admin-settings-tab-change", detail: "history" }, ...fallback },
  { id: "8-preview", chapterId: "8", title: "설정 미리보기", controlLabel: "미리보기", purpose: "현재 설정 초안이 공개 페이지에서 보이는 결과를 확인합니다.", outcome: "공개 데이터 변경 없이 관련 공개 화면이 열립니다.", href: "/admin/settings", target: "preview", ...fallback },
  { id: "8-save", chapterId: "8", title: "사이트 설정 저장", controlLabel: "변경사항 저장", purpose: "현재 설정 탭과 하위 임시 작업을 서버에 반영합니다.", outcome: "회사 정보, 푸터, 링크와 자료가 공개 사이트에 갱신됩니다.", href: "/admin/settings", target: "draft-save", ...fallback },
  { id: "8-avatar-file", chapterId: "8", title: "아바타 파일 선택", controlLabel: "파일 선택", purpose: "추가할 아바타 이미지 파일을 선택합니다.", outcome: "정사각형 자르기 화면이 열립니다.", href: "/admin/settings?tab=avatars", target: "avatar-upload", tabEvent: { name: "admin-settings-tab-change", detail: "avatars" }, ...fallback },
  { id: "8-avatar-crop", chapterId: "8", title: "아바타 자르고 추가", controlLabel: "자르고 추가", purpose: "선택 이미지의 사용할 영역을 정사각형으로 확정합니다.", outcome: "잘린 이미지가 임시 아바타 목록에 추가됩니다.", href: "/admin/settings?tab=avatars", target: "avatar-upload", tabEvent: { name: "admin-settings-tab-change", detail: "avatars" }, ...fallback },
  { id: "8-avatar-up", chapterId: "8", title: "아바타 앞으로 이동", controlLabel: "앞으로", purpose: "선택 아바타의 노출 순서를 한 칸 앞당깁니다.", outcome: "새 순서가 임시 목록에 반영됩니다.", href: "/admin/settings?tab=avatars", target: "avatar-actions", tabEvent: { name: "admin-settings-tab-change", detail: "avatars" }, ...fallback },
  { id: "8-avatar-down", chapterId: "8", title: "아바타 뒤로 이동", controlLabel: "뒤로", purpose: "선택 아바타의 노출 순서를 한 칸 늦춥니다.", outcome: "새 순서가 임시 목록에 반영됩니다.", href: "/admin/settings?tab=avatars", target: "avatar-actions", tabEvent: { name: "admin-settings-tab-change", detail: "avatars" }, ...fallback },
  { id: "8-avatar-delete", chapterId: "8", title: "아바타 삭제", controlLabel: "삭제", purpose: "선택 아바타를 임시 목록에서 제거합니다.", outcome: "상단 저장 후 선택 목록에서 사라집니다.", href: "/admin/settings?tab=avatars", target: "avatar-actions", tabEvent: { name: "admin-settings-tab-change", detail: "avatars" }, ...fallback },
  ...
  { id: "9-result", chapterId: "9", title: "검색 결과로 이동", controlLabel: "검색 결과", purpose: "원하는 결과를 선택해 해당 화면이나 세부 탭으로 바로 이동합니다.", outcome: "미저장 변경 확인 후 선택한 관리자 화면이 열립니다.", href: "/admin", target: "admin-search", fallbackTarget: "admin-navigation" },
];
