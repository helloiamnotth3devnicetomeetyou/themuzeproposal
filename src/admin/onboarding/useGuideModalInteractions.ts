...
export function useGuideModalInteractions({
  ...
  guideWasOpenRef: RefObject<boolean>;
  setWelcomeOpen: (value: boolean) => void;
  ...
  setRect: (
    value: { top: number; left: number; width: number; height: number } | null,
  ) => void;
  setPopoverPosition: (value: null) => void;
}) {
