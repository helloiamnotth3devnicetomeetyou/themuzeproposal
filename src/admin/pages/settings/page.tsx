...
export default function SettingsAdmin({
  ...
  const railItems: Array<{
    ...
    },
    {
      ...
      copy: "프레스킷 · 프로필 PDF",
      icon: FileArchive,
      ready: Boolean(business.pressKitUrl || business.profilePdfUrl),
      meta:
  ...
  return (
    <ContentWorkbench
      ...
      tabs={(isSuperAdmin
        ...
        ...item,
        complete: railItems.find((railItem) => railItem.id === item.id)?.ready,
        missing: railItems.find((railItem) => railItem.id === item.id)?.ready
          ? 0
          : 1,
      }))}
      activeTab={tab}
          ...
          <>
            <div className="content-section-heading settings-section-heading">
              <div>
                <h3>푸터</h3>
                <p>
                  모든 공개 페이지 하단에 반복해서 표시되는 저작권 문구입니다.
                </p>
              </div>
            ...
            >
              <div>
                <strong>
                  {company.name_en || company.name_ko || "THE MUZE"}
                </strong>
              </div>
          ...
          <>
            <div className="content-section-heading settings-section-heading">
              <div>
                <h3>비즈니스 자료</h3>
                <p>
                  Contact Business 탭에서 공개할 프레스킷 ZIP과 프로필
                  PDF입니다. ZIP은 서버에서 압축을 풀지 않습니다.
                </p>
              </div>
            ...
            <section className="settings-panel">
              <BusinessAssetField
                ...
                busy={saving}
                onUpload={(file) =>
                  void uploadBusinessAsset("pressKitUrl", file)
                }
              />
              <BusinessAssetField
                label="프로필 PDF"
