...
export const translations = {
  ko: {
    ...
    sections: {
      ...
      auditionDesc:
        "더뮤즈엔터테인먼트와 함께 글로벌 무대를 빛낼 차세대 아티스트를 찾습니다.",
      applyBtn: "지원하기",
    },
    footer: {
  ...
  en: {
    ...
    sections: {
      ...
      auditionDesc:
        "We are looking for the next generation of global artists to shine with THE MUZE Entertainment.",
      applyBtn: "APPLY NOW",
    },
    footer: {
  ...
  ja: {
    ...
    sections: {
      ...
      auditionDesc:
        "THE MUZE Entertainmentと共にグローバルな舞台で輝く次世代のアーティストを募集しています。",
      applyBtn: "応募する",
    },
    footer: {
