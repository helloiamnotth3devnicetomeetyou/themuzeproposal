...
export const publicMessages: Record<Locale, PublicMessages> = {
  ko: {
    ...
    artistScene: { select: "멤버 선택", scene: "콘셉트 장면", close: "프로필 닫기", previous: "이전 멤버", next: "다음 멤버", discography: "디스코그래피", openLink: "장면 링크 열기", profile: "프로필", groupProfile: "아티스트 프로필", expand: "소개 펼치기", collapse: "소개 접기", loading: "아티스트 장면을 불러오는 중…", notFound: "아티스트 장면을 찾을 수 없습니다.", back: "아티스트 목록으로" },
  ...
  en: {
    ...
    artistScene: { select: "Select a member", scene: "Concept scenes", close: "Close profile", previous: "Previous member", next: "Next member", discography: "Discography", openLink: "Open scene link", profile: "Profile", groupProfile: "Artist profile", expand: "Show introduction", collapse: "Hide introduction", loading: "Loading artist scene…", notFound: "Artist scene not found.", back: "Back to artists" },
  ...
  ja: {
    ...
    artistScene: { select: "メンバーを選択", scene: "コンセプトシーン", close: "プロフィールを閉じる", previous: "前のメンバー", next: "次のメンバー", discography: "ディスコグラフィー", openLink: "シーンリンクを開く", profile: "プロフィール", groupProfile: "アーティストプロフィール", expand: "紹介を表示", collapse: "紹介を閉じる", loading: "アーティストシーンを読み込み中…", notFound: "アーティストシーンが見つかりません。", back: "アーティスト一覧へ" },
