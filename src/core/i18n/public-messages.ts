...
export const publicMessages: Record<Locale, PublicMessages> = {
  ko: {
    ...
    protect: {
      ...
      fields: { artist: "아티스트", reportType: "신고 유형", title: "제목", content: "신고 내용", platform: "게시 플랫폼", postUrl: "게시물 URL", postedAt: "게시 일자", authorName: "게시물 작성자", postIp: "게시물 IP 주소", evidence: "첨부 자료", confirmation: "사실 확인 동의", captcha: "보안 인증" },
    ...
    artistScene: { select: "멤버 선택", scene: "콘셉트 장면", close: "프로필 닫기", previous: "이전 멤버", next: "다음 멤버", discography: "디스코그래피", openLink: "장면 링크 열기", profile: "프로필", groupProfile: "아티스트 프로필", expand: "소개 펼치기", collapse: "소개 접기", loading: "아티스트 장면을 불러오는 중…", notFound: "아티스트 장면을 찾을 수 없습니다.", back: "아티스트 목록으로", clickHint: "멤버를 클릭해보세요" },
  ...
  en: {
    ...
    protect: {
      ...
      fields: { artist: "Artist", reportType: "Report type", title: "Title", content: "Report details", platform: "Platform", postUrl: "Post URL", postedAt: "Date posted", authorName: "Post author", postIp: "Post IP address", evidence: "Evidence", confirmation: "Confirmation", captcha: "Security check" },
    ...
    artistScene: { select: "Select a member", scene: "Concept scenes", close: "Close profile", previous: "Previous member", next: "Next member", discography: "Discography", openLink: "Open scene link", profile: "Profile", groupProfile: "Artist profile", expand: "Show introduction", collapse: "Hide introduction", loading: "Loading artist scene…", notFound: "Artist scene not found.", back: "Back to artists", clickHint: "Click on a member" },
  ...
  ja: {
    ...
    protect: {
      ...
      fields: { artist: "アーティスト", reportType: "通報の種類", title: "タイトル", content: "通報内容", platform: "投稿プラットフォーム", postUrl: "投稿URL", postedAt: "投稿日", authorName: "投稿者", postIp: "投稿元IPアドレス", evidence: "添付資料", confirmation: "事実確認への同意", captcha: "セキュリティ認証" },
      ...
      errors: { maxFiles: "添付資料は最大3件まで登録できます。", fileType: (name) => `${name}：JPG、PNG、WEBP、GIF、PDFのみ添付できます。`, fileSize: (name) => `${name}：ファイルサイズは10MB以下にしてください。`, duplicate: (name) => `${name}：すでに添付されています。`, evidenceRequired: "侵害内容を確認できる証拠資料を1件以上添付してください。", confirmationRequired: "通報内容が事実に基づいていることを確認してください。", submitFailed: "通報を送信できませんでした。しばらくしてからもう一度お試しください。", INVALID_REQUEST: "入力内容をご確認のうえ、もう一度お試しください。", UNAUTHORIZED: "ログインが必要です。再度ログインしてお試しください。", RATE_LIMITED: "通報が多く送信されています。しばらくしてからもう一度お試しください。", FILE_TOO_LARGE: "添付ファイルは最大10MBまで登録できます。", INVALID_FILE_TYPE: "JPG、PNG、WEBP、GIF、PDFのみ添付できます。", UPLOAD_FAILED: "ファイルのアップロードに失敗しました。しばらくしてからもう一度お試しください。", SERVICE_UNAVAILABLE: "一時的にサービスをご利用いただけません。しばらくしてからもう一度お試しください。", SUBMISSION_FAILED: "通報を送信できませんでした。しばらくしてからもう一度お試しください。", CAPTCHA_FAILED: "セキュリティ認証に失敗しました。もう一度お試しください。" },
    },
    schedule: {
    ...
    artistScene: { select: "メンバーを選択", scene: "コンセプトシーン", close: "プロフィールを閉じる", previous: "前のメンバー", next: "次のメンバー", discography: "ディスコグラフィー", openLink: "シーンリンクを開く", profile: "プロフィール", groupProfile: "アーティストプロフィール", expand: "紹介を表示", collapse: "紹介を閉じる", loading: "アーティストシーンを読み込み中…", notFound: "アーティストシーンが見つかりません。", back: "アーティスト一覧へ", clickHint: "メンバーをクリックしてみてください" },
    discography: { loading: "ディスコグラフィーを読み込み中…", empty: "公開されたアルバムはありません。", loadError: "ディスコグラフィーを読み込めませんでした。", tabs: { concept: "コンセプト", intro: "トラック紹介", members: "メンバー" }, noDescription: "アルバム紹介は登録されていません。", noMembers: "登録されたメンバー情報はありません。", allMembers: "全体メンバー", noPhotos: "登録されたコンセプトフォトはありません。", photoCount: "枚", nowPlaying: "再生中", progress: "再生位置", previousTrack: "前のトラック", nextTrack: "次のトラック", play: "再生", pause: "一時停止", noAudio: "音源が登録されていません。", musicVideo: "ミュージックビデオを見る", newest: "新しい順", oldest: "古い順", sortAscending: "古い順に並べ替え", sortDescending: "新しい順に並べ替え", previousAlbum: "前のアルバム", nextAlbum: "次のアルバム" },
  },
};
