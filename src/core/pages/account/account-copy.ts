export const accountCopy = {
  ko: {
    ...
    titleAccent: "",
    intro:
      "이름과 로그인 정보를 최신 상태로 관리하세요. 변경한 정보는 이 계정을 사용하는 모든 곳에 반영됩니다.",
    profileTitle: "기본 정보",
    ...
    currentPasswordHint:
      "현재 비밀번호를 먼저 입력하세요. 입력을 마치면 자동으로 확인합니다.",
  ...
  en: {
    ...
    titleAccent: "",
    intro:
      "Keep your name and sign-in details current. Updates apply everywhere you use this account.",
    ...
    email: "EMAIL ADDRESS",
    emailHint:
      "Open the verification link sent to your new address to finish the change.",
    ...
    currentPasswordHint:
      "Enter your current password first. It will be checked when you finish typing.",
    ...
    passwordHint:
      "Confirm your current password, then use at least 12 characters for the new password.",
    ...
    captchaFailed: "Security verification failed. Please try again shortly.",
  ...
  ja: {
    ...
    titleAccent: "",
    intro:
      "名前とログイン情報を最新の状態に保ちます。変更内容は、このアカウントを使うすべての場所に反映されます。",
    profileTitle: "基本情報",
    ...
    currentPasswordHint:
      "最初に現在のパスワードを入力してください。入力後に自動で確認します。",
