...
describe("detectSocialPlatform", () => {
  it("detects instagram URLs", () => {
    expect(detectSocialPlatform("https://instagram.com/themuze")).toBe("instagram");
    expect(detectSocialPlatform("https://www.instagram.com/themuze")).toBe("instagram");
  });

  it("detects youtube URLs", () => {
    expect(detectSocialPlatform("https://youtube.com/channel/abc")).toBe("youtube");
  ...
  it("detects spotify URLs", () => {
    expect(detectSocialPlatform("https://open.spotify.com/artist/123")).toBe("spotify");
  });
