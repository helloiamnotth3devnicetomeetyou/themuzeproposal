...
function renderAlbum(spotify?: string) {
  render(<AlbumDetails activeTab="concept" album={album(spotify)} currentTrackIndex={-1} hoveredDisc={null} isPlaying={false} locale="ko" time={{ current: "0:00", total: "0:00" }} onNextTrack={vi.fn()} onPlayTrack={vi.fn()} onPreviousTrack={vi.fn()} onTabChange={vi.fn()} onTogglePlay={vi.fn()} />);
}
