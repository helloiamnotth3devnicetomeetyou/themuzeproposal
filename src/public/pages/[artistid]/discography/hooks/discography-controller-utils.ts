...
export function previewToAlbum(preview: AlbumPreviewPayload | null): DiscographyAlbum | null {
  ...
  return {
    ...
    desc: { ko: preview.album.description_ko, en: preview.album.description_en, ja: preview.album.description_ja },
    links: { spotify: spotifyAlbumHref(preview.album.spotify_id), youtube: safeHref(preview.album.youtube_url) },
  };
}
