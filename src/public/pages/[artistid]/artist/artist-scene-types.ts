...
export type SceneCopy = { select: string; scene: string; close: string; previous: string; next: string; discography: string; openLink: string; profile: string; groupProfile: string; expand: string; collapse: string; clickHint: string };
