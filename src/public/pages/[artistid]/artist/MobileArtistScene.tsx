          ...
          {scenes.map((scene) => {
            ...
            const activeRegion = selectedMember
              ? scene.artist_scene_members.find(
                  (r) => r.member_id === selectedMember.id,
                )
              : null;
                  ...
                  <Image
                    ...
                    style={{
                      ...
                      ...(selectedMember
                        ? {
                            filter:
                              "grayscale(1) brightness(0.28) contrast(1.15)",
                          }
                        : {}),
                    }}
                  />
            ...
            <div className={styles.mobileMemberChips}>
              {activeMembers.map((member) => (
                <button
                  ...
                  type="button"
                  className={
                    (selectedMember as Member | null)?.id === member.id
                      ? styles.mobileMemberChipActive
                      : ""
                  }
                  onClick={() => onSelectMember(member.id)}
                >
