  ...
  const fieldError = (id: string) =>
    isMissing(id)
      ? {
          ...
          "aria-describedby": "report-validation-summary",
        }
      : {};
  return (
    <>
      ...
      <div className={styles.formRow}>
        ...
        >
          <CustomSelect
            className={styles.customSelect}
            ariaLabel={fields.platform}
            value={form.platform}
            onChange={updateSelect("platform")}
            placeholder={placeholders.platform}
            options={t.protect.platforms}
          />
        </div>
      </div>
      <div className={styles.formRow}>
        ...
        <input
          ...
          required
          value={form.postUrl}
          onChange={updateField("postUrl")}
          placeholder={placeholders.postUrl}
          {...fieldError("postUrl")}
        />
      </div>
      <div className={styles.formRow}>
      ...
      <div className={styles.formRow}>
        <label htmlFor="postIp">{fields.postIp}</label>
        <input
          id="postIp"
          maxLength={64}
          value={form.postIp}
          onChange={updateField("postIp")}
          placeholder={placeholders.postIp}
        />
      </div>
      ...
      >
        {submitting
          ? t.protect.submitting
          : holdingSubmit
            ? t.protect.keepHolding
            : t.protect.submit}
      </button>
    </>
  );
