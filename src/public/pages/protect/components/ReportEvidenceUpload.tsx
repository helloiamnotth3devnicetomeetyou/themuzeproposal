...
export default function ReportEvidenceUpload({
  fileSlots,
  files,
  onAddFiles,
  onRemoveFile,
  ...
  return (
    <div className={`${styles.formRow} ${styles.alignTop}`}>
      <span className={styles.rowLabel}>
        {t.protect.fields.evidence} <i>*</i>
      </span>
      <div className={styles.fileUploadArea}>
        <label className={styles.uploadButton}>
          <Upload aria-hidden="true" />
          <span>
            <b>{t.protect.upload}</b>
            <small>{t.protect.uploadHint}</small>
          </span>
                ...
                file && (
                  ...
                  >
                    ...
                    <button
                      ...
                      aria-label={t.protect.removeFile(file.name)}
                    >
