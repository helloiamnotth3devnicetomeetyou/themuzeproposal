...
export const inquiryLabels = {
  en: {
    account: "Account",
    notice_event: "Notices & events",
    goods_md: "Goods & MD",
    site_error: "Website issue",
    other: "Other",
    brand_collaboration: "Brand collaboration",
    advertising_sponsorship: "Advertising & sponsorship",
    md_licensing: "MD & licensing",
    performance_event: "Performance & event",
    other_business: "Other business proposal",
  },
  ja: {
    account: "アカウント",
    notice_event: "お知らせ・イベント",
    goods_md: "グッズ・MD",
    site_error: "サイトの不具合",
    other: "その他",
    brand_collaboration: "ブランドコラボレーション",
    advertising_sponsorship: "広告・スポンサーシップ",
    md_licensing: "MD・ライセンス",
    performance_event: "公演・イベント",
    other_business: "その他のビジネス提案",
  },
} as const;
...
export const contactCopy = {
  ko: {
    ...
    placeholders: {
      company: "회사명 또는 소속을 입력해 주세요.",
      nameBusiness: "담당자 성함을 입력해 주세요.",
      nameGeneral: "이름을 입력해 주세요.",
      phoneBusiness: "연락 가능한 번호를 입력해 주세요.",
      phoneGeneral: "연락처를 입력해 주세요. (선택)",
      proposal:
    ...
    privacy: {
      ...
      items: [
        {
          term: "수집 항목",
          desc: "이름, 이메일, 연락처, 회사명·소속(비즈니스 문의 시), 문의 내용",
        },
        {
          term: "이용 목적",
          desc: "문의 접수, 본인 확인, 문의 내용 검토 및 답변",
        },
        {
          term: "보유 기간",
          desc: "문의 처리 완료 후 3년 또는 관계 법령에서 정한 기간",
        },
      ],
    ...
    validation: {
      ...
      company: "회사명 또는 소속을 입력해 주세요.",
      nameBusiness: "담당자 이름을 입력해 주세요.",
      nameGeneral: "이름을 입력해 주세요.",
      phone: "연락처를 입력해 주세요.",
      email: "이메일 주소를 입력해 주세요.",
      emailInvalid: "올바른 이메일 주소를 입력해 주세요.",
      messageBusiness: "제안 내용을 입력해 주세요.",
      messageGeneral: "문의 내용을 입력해 주세요.",
      consent: "개인정보 수집·이용에 동의해 주세요.",
      fileType: "PDF 형식의 파일만 첨부할 수 있습니다.",
      fileSize: "첨부 파일은 최대 5MB까지 등록할 수 있습니다.",
      captcha: "보안 인증을 완료해 주세요.",
    },
    errors: {
      INVALID_REQUEST: "입력 내용을 다시 확인해 주세요.",
      UNAUTHORIZED: "로그인이 필요합니다. 다시 로그인한 뒤 시도해 주세요.",
      RATE_LIMITED: "문의 요청이 너무 많습니다. 잠시 후 다시 시도해 주세요.",
      FILE_TOO_LARGE: "첨부 파일은 최대 5MB까지 등록할 수 있습니다.",
      INVALID_FILE: "이 문의 유형에는 파일을 첨부할 수 없습니다.",
      INVALID_FILE_TYPE: "PDF 형식의 파일만 첨부할 수 있습니다.",
  ...
  en: {
    intro:
      "Choose the channel that best fits your inquiry. Our team will review your message and reply by email.",
    general: "General inquiry",
    business: "Business",
    form: "How can we help?",
    businessForm: "Partnership, advertising & collaboration",
    ...
    consent: "Consent to personal-information collection and use",
    submit: "Send inquiry",
    submitting: "Sending...",
    ...
    placeholders: {
      ...
      nameBusiness: "Enter the contact person's name.",
      nameGeneral: "Enter your name.",
      phoneBusiness: "Enter a phone number we can reach you at.",
      phoneGeneral: "Enter your phone number. (optional)",
      proposal:
        "Describe your proposal and the collaboration you have in mind — specifics help us review it faster.",
      message:
        "Share the details of your inquiry so we can respond quickly and accurately.",
    },
    attachment: {
    ...
    privacy: {
      ...
      items: [
        {
          term: "Items collected",
          desc: "Name, email, phone, company/organization (for business inquiries), inquiry content",
        },
        {
          term: "Purpose of use",
          desc: "Receiving inquiries, identity verification, reviewing and responding to inquiries",
        },
        {
          term: "Retention period",
          desc: "3 years after the inquiry is resolved, or the period required by applicable law",
        },
      ],
    ...
    validation: {
      ...
      nameBusiness: "Please enter the contact person's name.",
      nameGeneral: "Please enter your name.",
      phone: "Please enter your phone number.",
      email: "Please enter your email address.",
      emailInvalid: "Please enter a valid email address.",
      messageBusiness: "Please enter your proposal details.",
      messageGeneral: "Please enter your inquiry.",
      consent:
        "Please consent to the collection and use of personal information.",
      fileType: "Only PDF files can be attached.",
      fileSize: "Attachments must be 5MB or smaller.",
    ...
    errors: {
      ...
      RATE_LIMITED: "Too many inquiries submitted. Please try again shortly.",
      FILE_TOO_LARGE: "Attachments must be 5MB or smaller.",
      INVALID_FILE: "This inquiry type does not accept attachments.",
  ...
  ja: {
    intro:
      "お問い合わせ内容に合う窓口を選択してください。内容を確認のうえ、担当者がメールでご返信します。",
    general: "一般お問い合わせ",
    business: "ビジネス",
    form: "どのようなご用件ですか？",
    businessForm: "協業・広告・提携のご提案",
    required: "は必須項目です。",
    ...
    placeholders: {
      company: "会社名または所属を入力してください。",
      nameBusiness: "ご担当者様のお名前を入力してください。",
      nameGeneral: "お名前を入力してください。",
      phoneBusiness: "ご連絡可能な電話番号を入力してください。",
      phoneGeneral: "電話番号を入力してください。（任意）",
      proposal:
        "ご提案内容とご希望の協業方針を具体的にご記入いただくと、検討がスムーズです。",
      message:
        "お問い合わせ内容を詳しくご記入いただくと、より早く正確にご案内できます。",
    },
    attachment: {
      label: "提案書の添付",
      chooseTitle: "ファイルを選択してください。",
      hint: "PDF・最大5MB",
      select: "ファイルを選択",
    ...
    privacy: {
      ...
      items: [
        {
          term: "収集項目",
          desc: "氏名、メールアドレス、電話番号、会社名・所属（ビジネスお問い合わせの場合）、お問い合わせ内容",
        },
        {
          term: "利用目的",
          desc: "お問い合わせの受付、本人確認、お問い合わせ内容の確認およびご返信",
        },
        {
          term: "保有期間",
          desc: "お問い合わせ対応完了後3年間、または関係法令で定める期間",
        },
      ],
    ...
    validation: {
      ...
      messageBusiness: "ご提案内容を入力してください。",
      messageGeneral: "お問い合わせ内容を入力してください。",
      consent: "個人情報の収集・利用に同意してください。",
      fileType: "PDF形式のファイルのみ添付できます。",
      fileSize: "添付ファイルは最大5MBまで登録できます。",
    ...
    errors: {
      ...
      RATE_LIMITED:
        "お問い合わせが多く送信されています。しばらくしてからもう一度お試しください。",
      FILE_TOO_LARGE: "添付ファイルは最大5MBまで登録できます。",
      INVALID_FILE: "このお問い合わせ種別にはファイルを添付できません。",
      INVALID_FILE_TYPE: "PDF形式のファイルのみ添付できます。",
      UPLOAD_FAILED:
        "ファイルのアップロードに失敗しました。しばらくしてからもう一度お試しください。",
      SERVICE_UNAVAILABLE:
        "一時的にサービスをご利用いただけません。しばらくしてからもう一度お試しください。",
      SUBMISSION_FAILED:
        "お問い合わせの送信中に問題が発生しました。しばらくしてからもう一度お試しください。",
      CAPTCHA_FAILED:
