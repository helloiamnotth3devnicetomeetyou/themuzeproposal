...
const makeSettings = (overrides: Partial<SiteSettingsPreviewPayload> = {}): SiteSettingsPreviewPayload => ({
  company: {
    name_ko: "더뮤즈",
    name_en: "THE MUZE",
    name_ja: "ザ・ミューズ",
...
describe("Footer component", () => {
  ...
  it("renders social links when provided", () => {
    const settings = makeSettings({
      social: [
        { id: "s1", platform: "instagram", label: "Instagram", url: "https://instagram.com/themuze" },
        { id: "s2", platform: "youtube", label: "YouTube", url: "https://youtube.com/themuze" },
      ],
    });
  ...
  it("filters out social links with unsafe URLs", () => {
    const settings = makeSettings({
      social: [
        { id: "s1", platform: "other", label: "Bad", url: "javascript:alert(1)" },
        { id: "s2", platform: "instagram", label: "IG", url: "https://instagram.com/themuze" },
      ],
    });
    render(<Footer initialSettings={settings} />);
